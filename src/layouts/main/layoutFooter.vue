    ...
    <div>
        ...
        >
            ...
            >
                ...
                <q-route-tab to="/gamePage?tag=game" class="min-height50" name="best" icon="star" :label="$t('layoutFooter.routeTab.official')"/>
                <q-route-tab to="/gamePage?tag=indie" class="min-height50" name="challenge" icon="emoji_events" :label="$t('layoutFooter.routeTab.challenge')"/>

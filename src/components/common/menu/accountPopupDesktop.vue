...
<!--                        <q-separator vertical class="q-mx-sm"></q-separator>-->
            ...
            <router-link to="/profile">
                <q-item clickable>
                    <q-item-section>
                        <div class="row">
                            <q-icon name="fas fa-user" class="q-mr-md self-center"></q-icon><div class="self-center">내 프로필</div><!--한국어-->
                        </div>
                    </q-item-section>
                </q-item>
            </router-link>
            ...
            <router-link :to="`/channel/${this.$store.getters.user.channel_id}`">
                <q-item clickable>
                    <q-item-section>
                        <div class="row">
                            <q-icon name="far fa-id-card" class="q-mr-md self-center"></q-icon><div class="self-center">내 채널</div><!--한국어-->
                        </div>
                    </q-item-section>
                </q-item>
            </router-link>
            ...
            <a :href="$store.getters.supportUrl">
                <q-item clickable>
                    <q-item-section>
                        <div class="row">
                            <q-icon name="far fa-question-circle" class="q-mr-md self-center"></q-icon><div class="self-center">고객센터</div><!--한국어-->
                        </div>
                    </q-item-section>
                </q-item>
            </a>
...
<!--            </q-item>-->
            <q-item clickable @click="logout">
                <q-item-section>
                    <div class="row">
                        <q-icon name="fas fa-sign-out-alt" class="q-mr-md self-center"></q-icon><div class="self-center">로그아웃</div><!--한국어-->
                    </div>
                </q-item-section>
            </q-item>
        </q-list>

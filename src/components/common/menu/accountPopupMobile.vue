                ...
                <q-item class="menuItem" clickable>
                    <q-item-section>
                        <div class="row">
                            ...
                            <div class="menuText">내 프로필</div><!--한국어-->
                        </div>
                    </q-item-section>
                </q-item>
            </router-link>
                ...
                <q-item class="menuItem" clickable>
                    <q-item-section>
                        <div class="row">
                            ...
                            <div class="menuText">내 채널</div><!--한국어-->
                        </div>
                    </q-item-section>
                </q-item>
            </router-link>
                ...
                <q-item class="menuItem" clickable>
                    <q-item-section>
                        <div class="row">
                            ...
                            <div class="menuText">고객센터</div><!--한국어-->
                        </div>
                    </q-item-section>
                </q-item>
            </a>
            ...
            <q-item class="menuItem" clickable @click="logout">
                <q-item-section>
                    <div class="row">
                        ...
                        <div class="menuText">로그아웃</div><!--한국어-->
                    </div>
                </q-item-section>
            </q-item>
        </q-list>

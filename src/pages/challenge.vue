        ...
        <div class="maxWidth">
            ...
            <div class="q-pt-none">
                <div class="cardContainer" v-if="$store.getters.isSearchGame">
                    <game-card
                        v-for="(game, index) in $store.getters.searchGames"
                        :key="index"
                        :index="index"
                        class="card"
                        :data="game"
                ...
                <div class="cardContainer" v-else>
                    <game-card
                        v-for="(game, index) in $store.getters.challengeGames"
                        :key="index"
                        :index="index"
                        class="card"
                ...
                <div
                    v-if="$store.getters.challengeGames.length === 0"
                    class="cardContainer"
                >
    ...
    async mounted() {
        ...
        this.metaSetting = new MetaSetting({
            ...
            meta: [
                {
                    name: "description",
                    content: `${this.$t("pageDescription.challenge")}`,
                },
                {
                    property: "og:url",
                    content: `${this.$store.getters.VUE_APP_ZEMPIE_URL}challenge`,
                },
                {
                    property: "og:title",
                    content: `${this.$t("pageTitle.challenge")} | Zempie.com`,
                },
                {
